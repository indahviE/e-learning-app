...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-1 gap-6 mb-6">
                ...
                <div class="rounded-t mb-0 px-0 border-0">
                    <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative w-full max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Data Pembayaran Yang
                                Belum Di Periksa</h3>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($data_pembayaran_pending as $data)
                                    <tr class="text-gray-700 dark:text-gray-100 ">
                                        ...
                                        <td
                                            class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                            <a href="{{ $data->bukti_bayar }}" target="_blank" class="font-bold"
                                                style="text-decoration: underline; color:rgb(6, 154, 212);">
                                                [ LIHAT BUKTI BAYAR ]
                                            </a>
                                        </td>
                                        ...
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs p-4">
                                            ...
                                            <span
                                                class="bg-purple-100 text-purple-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">{{ $data->status == 'menunggu konfirmasi' ? 'Menunggu' : '' }}</span>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <form action="/pembayaran/accept/{{ $data->id }}" method="post">
                                                @csrf
                                                <button type="submit"
                                                    class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-xs px-3 py-1.5 text-center me-2 mb-2">Accept
                                                    Pembayaran</button>
            ...
            <div id="" class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    <div class="font-medium">Pembayaran Yang Telah Valid</div>
                </div>
                            ...
                            @foreach ($data_pembayaran as $data)
                                <tr class="text-gray-700 dark:text-gray-100">
                                    ...
                                    <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs p-4">
                                        ...
                                        <span
                                            class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">{{ $data->status == 'pembayaran valid' ? 'Valid' : '' }}</span>
                                    </td>

                                    <td
                                        class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 flex flex-col ">

                                        {{-- <a href="/pembayaran/update/{{ $data->id }}" type="submit"
                                            class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-xs px-3 py-1.5 text-center me-2 mb-2">Accept
                                            Pembayaran</a> --}}
