    ...
    <div class="relative z-10 flex items-center justify-center w-full h-full">
        <form action="/register" method="post"
            ...
            <div class="text-center">
                ...
                <p class="text-gray-500 text-sm mt-1">Daftar sekarang untuk mulai belajar mudah, nyaman, dan cepat.</p>
            </div>
            ...
            @if($errors->any())
                <ul class="bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded-md text-sm list-disc list-inside">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a href="./login" class="text-cyan-600 hover:underline text-sm font-medium">
                    Sudah punya akun?
                </a>
            </div>
        </form>
