...
<form method="POST" action="/pengajar/update/{{$data->id}}" enctype="multipart/form-data" class="flex items-center h-screen"> 
    @csrf 
    ...
    <div class="bg-white  shadow-xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 w-10/12 mx-auto">
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <textarea name="keahlian" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
